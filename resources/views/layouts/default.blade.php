...
<body>
    ...
    <div class="colour-block">
        ...
        <div class="uk-section uk-padding-remove">
            <div class="uk-container uk-padding-remove" uk-parallax="opacity: 0,1; x: -50, 0; viewport: 0.4;">
    ...
    <div class="white-block">
        {{-- section and container in here--}}
        <div class="uk-section uk-padding-remove">
            <div class="uk-container uk-padding-remove uk-text-right" uk-parallax="opacity: 0,1; x: 50, 0; viewport: 0.4;">
